...
public class CustomTypes {
    ...
    public static String[] rouletteNumbersD2 = {
            "0", "32", "15", "19", "4", "21", "2", "25", "17", "34",
            "6", "27", "13", "36", "11", "30", "8", "23", "10", "5",
            "24", "16", "33", "1", "20", "14", "31", "9", "22", "18",
    ...
    public static int getNumberIndex(String number) {
        for (int i = 0; i < rouletteNumbersD2.length; i++) {
            if (rouletteNumbersD2[i].equals(number)) {
                return i;
            }
        }
        return -1;
